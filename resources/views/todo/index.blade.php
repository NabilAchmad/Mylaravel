<x-app-layout>
    ...
    <script>
        ...
        function addTodoToList(todo) {
            ...
            div.className = 'todo-item bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border-l-4 border-indigo-500 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200';
